...
class CreateCustomer:
    ...
    dd_GSTTreatment = (By.XPATH,"//label[text()='GST treatment']/following-sibling::select")
    options_GSTTreatment =(By.XPATH,"//label[text()='GST treatment']/following-sibling::select//option")
    ...
    dd_BillingCountry = (By.XPATH,"(//label[normalize-space()='Country']/following-sibling::select)[1]")
    options_billingcountry = (By.XPATH,"//label[contains(text(),'Billing')]/following::select[contains(@label,'Country')]/option")
    dd_BillingState = (By.XPATH,"(//label[normalize-space()='State']/following-sibling::select)[1]")
    options_billingstate = (By.XPATH, "//label[text()='Billing']/following::label[text()='State']/following-sibling::select[1]//option")
    inp_BillingCity = (By.XPATH,"(//label[normalize-space()='City']/following-sibling::input)[1]")
    inp_BillingZip = (By.XPATH,"(//label[normalize-space()='Zip']/following-sibling::input)[1]")
    #Shipping_Address
    checkbx_SameasBilling = (By.XPATH,"//input[@id='bil_checkBox']")
    btn_Shipping_EnterManually = (By.XPATH,"(//label[normalize-space()='Country']/following-sibling::select)[2]")
    ...
    dd_ShippingCountry = (By.XPATH,"(//label[normalize-space()='Country']/following-sibling::select)[2]")
    options_shippingcountry= (By.XPATH,"//label[contains(text(),'Shipping')]/following::select[contains(@label,'Country')]/option")
    dd_ShippingState = (By.XPATH,"(//label[normalize-space()='State']/following-sibling::select)[2]")
    options_shippingstate = (By.XPATH,"//label[text()='Shipping']/following::label[text()='State']/following-sibling::select[1]//option")
    inp_ShippingCity = (By.XPATH,"(//label[normalize-space()='City']/following-sibling::input)[2]")
    inp_ShippingZip = (By.XPATH,"(//label[normalize-space()='Zip']/following-sibling::input)[2]")
    #Note
    ...
    alert_msg_1_close_X_btn = (By.XPATH,"//div[14]//div[1]//div[1]//button[1]")
    alert_msg_2_close_X_btn = (By.XPATH,"//div[15]//div[1]//div[1]//button[1]")
    alert_msg_3_close_X_btn = (By.XPATH,"//div[16]//div[1]//div[1]//button[1]")
