...
class Create_Check:
    ...
    create_check_prod_save_btn = (By.XPATH,"//button[@class='btn btn-primary btn-loading sc-koXPp eXvGQA btn-block float-end']")
    ...
    def create_c_add_multiple_product_cao_with_changexpath(self, create_check_test_data):
        ...
        for index, (product_serv, qty, rate) in enumerate(
            ...
            self.actions.wait_for_element_clickable(self.create_check_prod_save_btn)
            self.actions.click(self.create_check_prod_save_btn)
